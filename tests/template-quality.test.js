...
assert.match(config, /id:\s+teaching[\s\S]*icon:\s+bi-book-fill/, 'teaching icon should be configured as a Bootstrap Icons class');
assert.equal(/id:\s+awards/.test(config), false, 'unused awards section should not be configured');
